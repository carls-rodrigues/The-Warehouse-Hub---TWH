...
pub struct ReceiveTransferUseCase<T: TransferRepository, D: WebhookDispatcher + 'static> {
    transfer_repo: Arc<T>,
    webhook_dispatcher: Arc<D>,
}

impl<T: TransferRepository, D: WebhookDispatcher + 'static> ReceiveTransferUseCase<T, D> {
